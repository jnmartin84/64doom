...
export COMMAND_N64TOOL="$N64TOOL -l 32M -h $HEADERNAME -o $CART_NAME.Z64 -t \"$CART_NAME\" $PROG_NAME.bin -s $MIDI_ROM_OFFSET $MIDIPATH/$MIDIFILE -s $ID_ROM_OFFSET $IDPATH/$IDFILE -s $WAD_ROM_OFFSET $WADPATH/$WADFILE"
