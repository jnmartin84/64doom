...
void R_RenderSegLoop (void)
{
    ...
    int            mid;
//-Werror fix
//r_segs.c: In function 'R_RenderSegLoop':
//r_segs.c:211: error: 'texturecolumn' may be used uninitialized in this function
//    fixed_t        texturecolumn;
    fixed_t        texturecolumn = -1;
    int            top;
    int            bottom;
